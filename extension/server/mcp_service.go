...
func (M *McpServiceImpl) getMCPConfig(ctx context.Context, mcpId string) (*types.MCPServerConfig, error) {
...
func (M *McpServiceImpl) ClientRunTool(ctx context.Context, req *types.ClientRunToolRequest) (*types.ClientRunToolResponse, error) {
