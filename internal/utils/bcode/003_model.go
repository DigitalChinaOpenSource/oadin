...
var (
	...
	ErrModelEngineIsBeingOperatedOn = NewBcode(http.StatusConflict, 30009, "The model engine is currently being operated on. Please try again later.")

	ErrModelEngineNotRun = NewBcode(http.StatusConflict, 30010, "The model engine is dead, please restart oadin server first.")
)
