...
This is the preview version v0.4.0 of OADIN. More features and stability are continuously being
...
Since OADIN needs to enable the CGO dependency, you may need to install [MinGW-W64](https://github.com/niXman/mingw-builds-binaries/releases) 
...
```sh
curl -X POST http://localhost:16688/oadin/v0.4/services/chat -X POST 
...
`https://localhost:11434/api/chat` to `http://localhost:16688/oadin/v0.4/api_flavors/ollama/api/chat`.
