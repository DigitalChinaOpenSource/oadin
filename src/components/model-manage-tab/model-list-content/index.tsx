        ...
        <div className={styles.titlepath}>
          ...
          <Tooltip title="/Users/lc/Library/Application\ Support/">
            ...
            {/* <span className={styles.changeFailed}>
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#ff6e38" viewBox="0 0 256 256">
            ...
            {/* <Button className={styles.changePath} type="text">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#5429ff" viewBox="0 0 256 256">
