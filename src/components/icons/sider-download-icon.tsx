...
interface SiderDownloadIconProps {
  width?: number;
  height?: number;
  fill?: string;
}

const SiderDownloadIcon: React.FC<SiderDownloadIconProps> = ({ width = 16, height = 16, fill = '#FFFFFF' }) => {
  return (
...
export default SiderDownloadIcon;
