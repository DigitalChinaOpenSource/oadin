    ...
    >
      ...
      >
        ...
        <Form.Item
          label="服务提供商厂商名称"
          name="purchaseType"
          rules={[{ required: true, message: '服务提供商厂商名称' }]}
        >
        ...
        <Form.Item
          label="URL"
          name="endpoint"
          rules={[{ required: true, message: '请输入服务提供商的URL', type: 'url' }]}
        >
        ...
        <Form.Item
          label="鉴权类型"
          name="authType"
          rules={[{ required: true, message: '请输入服务提供商的鉴权类型' }]}
        >
        ...
        <Form.Item
          label="鉴权Key"
          name="apiKey"
          rules={[{ required: true, message: '请输入服务提供商的鉴权信息' }]}
        >
