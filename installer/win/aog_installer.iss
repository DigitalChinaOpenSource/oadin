...
#define MyAppName "oadin"
#define MyAppVersion "0.4"
#define MyAppPublisher "Intel, Inc."
#define MyAppURL "https://github.com/intel/oadin"
#define MyAppExeName "oadin.exe"
#define MyAppAssocName MyAppName + " File"
#define MyAppAssocExt ".myp"
#define MyAppAssocKey StringChange(MyAppAssocName, " ", "") + MyAppAssocExt
#define MyAppDir "PATH/TO/OADIN"
...
OutputDir=output
OutputBaseFilename=oadin-setup
Compression=lzma
...
Name: runServer; Description: "Start oadin server after installation"; Flags: unchecked
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        MsgBox('无法启动 oadin server. 请手动运行 "oadin server start -d".' + #13#10 + '错误代码: ' + IntToStr(ErrorCode), mbError, MB_OK);
      end;
    end;
  end;
end;
